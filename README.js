<div class="row">
  ...
  <div class="col-md-9">
    ...
    <div class="row cuda">
      ...
      <div class="col-md-3 option block version" id="rocm4.x" style="text-decoration: line-through;">
    ...
    <div class="row">
      ...
      <div class="command-container">
        <div class="col-md-12" id="command"><pre>conda install pytorch torchvision torchaudio cudatoolkit=10.2 -c pytorch</pre></div>
      </div>
    </div>
  </div>
</div>
